...
ALLOWED_HOSTS = ['dochadzka.onrender.com', 'localhost', '127.0.0.1']
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Dočasne necháme API verejné, neskôr môžeme pridať autentifikáciu
    ]
}
